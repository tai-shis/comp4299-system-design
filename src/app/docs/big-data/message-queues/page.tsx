...
import MessageQueuesMDX from '@/markdown/big-data/message-queues.mdx';

export const metadata: Metadata = {
  title: 'Message Queues',
  description:
    'Message queues, pub/sub, durability, acknowledgements, and common implementations like Kafka, RabbitMQ, and SQS.',
};
