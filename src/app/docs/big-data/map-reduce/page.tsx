...
import MapReduceMDX from '@/markdown/big-data/map-reduce.mdx';

export const metadata: Metadata = {
  title: 'MapReduce',
  description:
    'MapReduce: batch vs. stream processing, the map/shuffle/reduce model, and modern alternatives like Apache Spark.',
};
